// This allows us to perform CRUD operations with our users collection
const { _ } = require("ajv")
...
User.prototype.login = function () {
  ...
  return new Promise(async (resolve, reject) => {
    ...
    if (attemptedUser && bcrypt.compareSync(this.data.password, attemptedUser.password)) {
      ...
      this.getAvatar()
      resolve("User.js: Username and password match")
    } else {
      reject("User.js: Invalid username / password")
    }
  })
}
